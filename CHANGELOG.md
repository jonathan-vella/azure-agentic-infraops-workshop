...
- make diagrams mandatory, add quota requirements, fix pre-work
...
- update schedule, team structure, and challenge content
...
- add pull-requests write permission to auto-version workflow
