...
> **Note**: Challenge 6 is not scored — it focuses on professional communication and soft skills.

## Challenge Flow

```
[C1: Requirements] → [C2: Architecture] → [C3: Bicep] → ⚡CURVEBALL⚡ → [C4: DR] → [C5: Load Test] → [C6: Showcase]
```
